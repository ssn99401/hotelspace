...
public class AdminManageClientVO {
	...
	public AdminManageClientVO(String clientID, String clientPassword, String clientName, String clientTel, Date clientBirth,
			Date clientRegDate, int clientMilage, int clientState) {
		super();
		this.clientID = clientID;
		this.clientPassword = clientPassword;
		this.clientName = clientName;
