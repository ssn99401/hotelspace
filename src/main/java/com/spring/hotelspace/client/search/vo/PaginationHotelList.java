...
public class PaginationHotelList {
	/** 한 페이지당 게시글 수 **/
	...
	public PaginationHotelList(int listCnt, int curPage) {
	...
	public String toString() {
		return "PaginationHotelList [pageSize=" + pageSize + ", rangeSize=" + rangeSize + ", curPage=" + curPage
