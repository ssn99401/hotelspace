$(document).ready(
		function() {
			...
			// toat popup js
			/*
			 * $ .toast({ heading : 'Welcome to Ample admin', text : 'Use the
			 * predefined ones, or specify a custom position object.', position :
			 * 'top-right', loaderBg : '#fff', icon : 'warning', hideAfter :
			 * 3500, stack : 6 })
			 */
