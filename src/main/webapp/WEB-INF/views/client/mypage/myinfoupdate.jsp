...
<!-- <script>
	...
	return (clientEmail != '' && clientEmail != 'undefined' && regex.test(clientEmail));
	}
	
	
	$(document).ready(function email_check( clientEmail ){
...
<body id="page-top">
	...
	<section>
		<div class="w3-sidebar2 w3-bar-block"
			style="position: absolute; width: 25%; height: 40%">
