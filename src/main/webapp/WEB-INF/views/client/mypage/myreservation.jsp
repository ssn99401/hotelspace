	...
	<section action=>
		<div class="w3-sidebar w3-bar-block" style="width: 25%; height: 28%">
			...
			<a href='myinfoUpdate.do' class="w3-bar-item w3-button"> 개인정보 수정
				...
				정보 </a> <a href="#" class="w3-bar-item w3-button"> 회원탈퇴 </a>
		</div>
							...
							<tbody>
								<c:forEach var="mR" items="${myReserv }">
									...
									<tr>
										...
										<td class="w3-center">${mR.reserveDate}</td>
										<td class="w3-center">${mR.reviewCheck}</td>
									</tr>
